...
The source code adheres to the specifications of Python 3.7 and heeds [*PEP 8 – Style Guide for Python Code*](https://www.python.org/dev/peps/pep-0008/). It has been compiled against Python 3.7.9/3.7.8 (Windows/Linux) and frozen using [PyInstaller](https://www.pyinstaller.org/) 4.2. The modules *calcopp-gui* and *sd2opp* were frozen including [PySimpleGUI](https://pypi.org/project/PySimpleGUI/) 4.34.0 and [NumPy](https://www.numpy.org/) 1.20.1, respectively.
...
The source code adheres the specifications of Fortran 2018 with GNU-specific extensions. It has been compiled using GFortran 10.1.0/10.0.1 (Windows/Linux) with static linking, all symbol table and relocation information removed, and optimization level set to “O3”.
