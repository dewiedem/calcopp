...
!   CalcOPP 2.0.5 - Calculation of Effective One-Particle Potentials
...
character(len = *), parameter      :: VERSION = '2.0.5'                                     ! Program version
...
subroutine print_greeting(ver)
    ...
    write(*, *) 'Copyright (c) 2021  Dr. Dennis Wiedemann (MIT License, see LICENSE file)'
